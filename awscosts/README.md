...
* R Packages: [ggplot2](https://github.com/tidyverse/ggplot2), [RSQLite](https://github.com/rstats-db/RSQLite), [tidyverse](https://tidyverse.tidyverse.org), [DBI](https://dbi.r-dbi.org)
...
### SQLite Table with AWS Cost Explorer Data
![SQLite Table](aws_spend_postgres.png)